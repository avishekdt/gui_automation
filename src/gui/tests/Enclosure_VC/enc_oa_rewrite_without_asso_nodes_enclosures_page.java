...
public class enc_oa_rewrite_without_asso_nodes_enclosures_page extends TestSuiteBase {
	...
	public void test_enc_oa_rewrite_without_asso_nodes_enclosures_page() {
		...
		try {
			...
			String sppLocation_toSelect_w = CONFIG.getProperty("additionalPkg_Comp_Downgrad_Rewrite_w");
			String sppLocation_toSelect_l = CONFIG.getProperty("additionalPkg_Comp_Downgrad_Rewrite_l");*/
