 ...
 * Author: Praveen AC
 * Date: 05/27/2016
 * Test case Description: Try to add a VC with invalid OA credentials from the VC context screen. 
 						Proper error message should be displayed and the option to edit the oa credentials 
 						should be provided. Edit the node and add correct oa credentials . 
...
public class enc_vc_add_with_wrong_oa_cred_context_screen extends TestSuiteBase{
	...
	@Test
	public void test_enc_vc_add_with_wrong_oa_cred_context_screen() {		
