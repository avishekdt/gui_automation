 ...
 * Test case Description: Check for:
                Add a VC node from context screen, 
                Do inventory
                Rewrite using "Force" button
 * Prerequisites: NAFirst run deploy_VC_from_Context_Screen.
 * Steps:
 * 1. Launch HPSUM.
...
public class enc_vc_rewrite_context_screen extends TestSuiteBase{
	...
	@Test
public void test_enc_vc_rewrite_context_screen() {		
