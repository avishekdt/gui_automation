...
public class dn_installation_option_downgrade_rewrite_both extends TestSuiteBase {	
	...
	public void test_dn_installation_option_downgrade_rewrite_both() {
		...
		try {
		    ...
		    */
			...
			if(!Nodes.deployNodeAdvMode_installation_Options(remoteHostIp_w1, remoteHostType_w1,"Downgrade & Rewrite Both")) {
				throw new TestException("Test Failed");
			}
