...
public class dn_installation_option_downgrade_rewrite_firmware_lin extends TestSuiteBase {	
	...
	@Test
	public void test_dn_installation_option_downgrade_rewrite_firmware() {
		...
		try {
			...
			String sppLocation_toSelect = CONFIG.getProperty("additional_Comp_Location_l");
			...
			printLogs("Remote host host IP: " + remoteHostIp_l1);
		    ...
		    */
			...
			if(!killRemoteHpsum(remoteHostDesc_l1, remoteHostIp_l1, remoteHostUserName1_l1, remoteHostPassword1_l1)) {
				printError("Failed to kill hpsum service in dn_installation_option_downgrade_rewrite_firmware");
			}
			...
			if(!Nodes.deployNodeAdvMode_installation_Options(remoteHostIp_l1, remoteHostType_l1,"Downgrade & Rewrite Firmware")) {
				throw new TestException("Test Failed");
			}
