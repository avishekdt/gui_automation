...
public class dn_installation_option_downgrade_software extends TestSuiteBase {	
	...
	public void test_dn_installation_option_downgrade_software() {
		...
		try {
		    ...
		    */
			...
			if(!Nodes.deployNodeAdvMode_installation_Options(remoteHostIp_w1, remoteHostType_w1,"Downgrade Software")) {
				throw new TestException("Test Failed");
			}
