...
public class dn_installation_option_downgrade_rewrite_software_lin extends TestSuiteBase {	
	...
	public void test_dn_installation_option_downgrade_rewrite_software() {
		...
		try {
		    ...
		    */
			...
			if(!Nodes.deployNodeAdvMode_installation_Options(remoteHostIp_l1, remoteHostType_l1,"Downgrade & Rewrite Software")) {
				throw new TestException("Test Failed");
			}
