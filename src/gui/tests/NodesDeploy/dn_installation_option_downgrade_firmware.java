...
public class dn_installation_option_downgrade_firmware extends TestSuiteBase {	
	...
	public void test_dn_installation_option_downgrade_firmware() {
		...
		try {
		    ...
		    */
			...
			if(!Nodes.deployNodeAdvMode_installation_Options(remoteHostIp_w1, remoteHostType_w1,"Downgrade Firmware")) {
				throw new TestException("Test Failed");
			}
