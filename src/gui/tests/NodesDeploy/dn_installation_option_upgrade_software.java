...
public class dn_installation_option_upgrade_software extends TestSuiteBase {	
	...
	public void test_dn_installation_option_upgrade_software() {
		...
		try {
			...
			*/
			...
			if(!Nodes.deployNodeAdvMode_installation_Options(remoteHostIp_w1, remoteHostType_w1,"Upgrade Software")) {
				throw new TestException("Test Failed");
			}
