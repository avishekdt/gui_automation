...
public class dn_installation_option_rewrite_software extends TestSuiteBase {	
	...
	public void test_dn_installation_option_rewrite_software() {
		...
		try {
			...
			if(!Nodes.deployNodeAdvMode_installation_Options(remoteHostIp_w1, remoteHostType_w1,"Rewrite Software")) {
				throw new TestException("Test Failed");
			}
