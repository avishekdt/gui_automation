...
public class dn_installation_option_rewrite_firmware_lin extends TestSuiteBase {	
	...
	public void test_dn_installation_option_rewrite_firmware() {
		...
		try {
			...
			if(!Nodes.deployNodeAdvMode_installation_Options(remoteHostIp_l1, remoteHostType_l1,"Rewrite Firmware")) {
				throw new TestException("Test Failed");
			}
