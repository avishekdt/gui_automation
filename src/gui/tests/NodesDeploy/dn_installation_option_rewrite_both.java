...
public class dn_installation_option_rewrite_both extends TestSuiteBase {	
	...
	public void test_dn_installation_option_rewrite_both() {
		...
		try {
			...
			if(!Nodes.deployNodeAdvMode_installation_Options(remoteHostIp_w1, remoteHostType_w1,"Rewrite Both")) {
				throw new TestException("Test Failed");
			}
