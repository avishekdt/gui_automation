...
public class node_check_status_no_app_comp extends TestSuiteBase {	
	...
	public void test_template_test_1() {
		...
		try {
			...
			// Add additional bundle of zip components.
			...
			//add windows node
			Nodes.without_spp = true;
			Nodes.no_app_comp = true;
			...
			Nodes.without_spp = false;
			Nodes.no_app_comp = false;
