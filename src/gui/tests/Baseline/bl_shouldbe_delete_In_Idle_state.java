...
/*TC Description: Delete baseline should be allowed when node in idle, inactive or initialized state.
Author: Praveen AC
date: 04/29/2016*/
//

public class bl_shouldbe_delete_In_Idle_state extends TestSuiteBase {	
	...
	@Test
	public void test_bl_shouldbe_delete_In_Installdone_state() {
		...
		try {
			...
			// 4. Delete additional baseline after the installation is done.
