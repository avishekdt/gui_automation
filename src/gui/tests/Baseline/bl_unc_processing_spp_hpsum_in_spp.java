 ...
 * End Date: 04/28/2016
 * Need to have unc path before running this test case.
*/
public class bl_unc_processing_spp_hpsum_in_spp extends TestSuiteBase {	
	...
	@Test
	public void test_bl_unc_processing_cbl_hpsum_in_spp() {
		...
		try {
			...
			String ablUncPathKey 		= "SPPPkg_UNC_Location";
			String ablUncUserNameKey 	= "additionalPkg_UNC_UserName1"; 
			String ablUncPasswordKey 	= "additionalPkg_UNC_Password1";
			String sppLocation_toSelect = CONFIG.getProperty("SPPPkg_UNC_Location");
			...
			printLogs("Adding custom SPP "+sppLocation_toSelect);
			...
			// 5. Perform Node inventory with UNC path BL
			...
			// 6. Deploy the node with the UNC path BL
