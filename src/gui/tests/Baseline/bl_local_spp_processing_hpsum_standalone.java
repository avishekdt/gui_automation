...
*/
public class bl_local_spp_processing_hpsum_standalone extends TestSuiteBase {	
	...
	@Test
	public void test_bl_local_spp_processing_hpsum_standalone() {
		...
		try {
			...
			if(currentOsName.contains("windows")) {
				...
				sppLocation_toSelect = sppLocation_toSelect_w + "/hp/swpackages";
			}
			else {
				...
				sppLocation_toSelect = sppLocation_toSelect_l + "/hp/swpackages";
			}
