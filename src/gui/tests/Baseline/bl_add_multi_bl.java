...
//
//Assertion: 
//Add multiple SPPs and verify they get added correctly.
//

public class bl_add_multi_bl extends TestSuiteBase {	
	String test_name 		= this.getClass().getSimpleName();
	String test_result 		= "PASS";
	static boolean manual 	= true;			// Make this false when test is automated.
	...
	@Test
	public void test_bl_add_multi_bl() {
		...
		try {
			...
			if(manual) {
				appendHtmlComment("This test needs addition of multiple SPPs - returning Manual now");
				printLogs("This test needs addition of multiple SPPs - returning Manual now");
