...
// Assertion: 
// Check remote login and shutdown. 
// 

public class logout_screen_login_remote_shutdown extends TestSuiteBase {
	...
	// Start the test.
	@Test
	public void test_logout_screen_login_remote_shutdown() {
		...
		try {
			...
			if(manual) {
				printLogs("Remote access can not be automated.");
