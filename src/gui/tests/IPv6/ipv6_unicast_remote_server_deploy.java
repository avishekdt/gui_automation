 ...
 * Author: Praveen AC
 * Date: 05/13/2016
 * Test case Description: Verify that HP SUM can add remote server node with unicast IPV6 address and deploy on the same.
 * Prerequistes: Configure localhost and remote server node with unicast IPV6 IP address. (Optional: Disable IPv4 address)
 * Steps:
 * 1. Launch HPSUM.
 ...
 * Variables to update: remoteHostIpv6u_w1, remoteHostIpv6u_l1
 */



public class ipv6_unicast_remote_server_deploy extends TestSuiteBase {
	...
	@Test
	public void test_ipv6_unicast_remote_server_deploy() {
		...
		try {
			...
			String remoteHostIp_w1 			= CONFIG.getProperty("remoteHostIpv6u_w1");
			...
			String remoteHostIp_l1 			= CONFIG.getProperty("remoteHostIpv6u_l1");
