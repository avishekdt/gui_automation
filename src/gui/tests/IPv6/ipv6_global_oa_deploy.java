 ...
 * Author: Praveen AC
 * Date: 05/16/2016
 * Test case Description: Deployment of OA with gobal IPv6 address.
 * Prerequistes: Configure localhost and OA node with global IPV6 IP address. (Optional: Disable IPv4 address)
 * Steps:
 * 1. Launch HPSUM.
 ...
 * Variables to update: remoteHostIpv6g_oa1
 */



public class ipv6_global_oa_deploy extends TestSuiteBase {
	...
	@Test
	public void test_ipv6_global_oa_deploy() {
