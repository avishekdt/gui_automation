 ...
 * Prerequistes: IPV6  Global DNS name is configured in the remote node.
 * Steps:
 * 1. Launch HPSUM.
...
public class ipv6_global_dns_add_deploy extends TestSuiteBase {
	...
	@Test
	public void test_ipv6_global_dns_add_deploy() {
		...
		try {
			...
			String remoteHostIp_w1 			= CONFIG.getProperty("remoteHostIpv6gDNS_w1");
			...
			String remoteHostIp_l1 			= CONFIG.getProperty("remoteHostIpv6gDNS_l1");
