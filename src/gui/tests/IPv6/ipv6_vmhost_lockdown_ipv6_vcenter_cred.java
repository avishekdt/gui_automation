 ...
 * 						IPv6 address of Vcenter should be specified while adding the node.
 * Prerequisites: Configure localhost and remote server node with global IPV6 IP address. 
 * 					(Optional: Disable IPv4 address)
...
public class ipv6_vmhost_lockdown_ipv6_vcenter_cred extends TestSuiteBase{
	...
	@Test
	public void test_ipv6_vmhost_lockdown_ipv6_vcenter_cred() {
		...
		try {
			...
			String vcenterIP_vm1 			= CONFIG.getProperty("vcenterIPv6_vm1");
			String vcentertUserName1_vm1 	= CONFIG.getProperty("vcenterUserName1_vm1");
			String vcenterPassword1_vm1 	= CONFIG.getProperty("vcenterPassword1_vm1");
