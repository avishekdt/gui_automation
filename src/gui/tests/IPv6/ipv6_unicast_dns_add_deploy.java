 ...
 * Author: Praveen AC
 * Date: 05/16/2016
 * Test case Description: Using ipv6 DNS name for the remote server and the deployment should be successful.
 * Prerequistes: IPV6  Unicast DNS name is configured in the remote node.
 * Steps:
 * 1. Launch HPSUM.
 ...
 * Variables to update: remoteHostIpv6uDNS_w1, remoteHostIpv6uDNS_l1
 */



public class ipv6_unicast_dns_add_deploy extends TestSuiteBase {
	...
	@Test
	public void test_ipv6_unicast_dns_add_deploy() {
		...
		try {
			...
			String remoteHostIp_w1 			= CONFIG.getProperty("remoteHostIpv6uDNS_w1");
			String remoteHostUserName1_w1 	= CONFIG.getProperty("remoteHostUserName1DNS_w1");
			String remoteHostPassword1_w1 	= CONFIG.getProperty("remoteHostPassword1DNS_w1");
			String remoteHostDesc_w1 		= "Windows";
			String remoteHostType_w1 		= "NodeType_windows";
			String remoteHostIp_l1 			= CONFIG.getProperty("remoteHostIpv6uDNS_l1");
			String remoteHostUserName1_l1 	= CONFIG.getProperty("remoteHostUserName1DNS_l1");
			String remoteHostPassword1_l1 	= CONFIG.getProperty("remoteHostPassword1DNS_l1");
