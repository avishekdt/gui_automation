 ...
 * Author: Praveen AC
 * Date: 05/16/2016
 * Test case Description: Verify that HP SUM can add VC node with unicast IPV6 address and deploy on the same.
 * Prerequistes: Configure localhost and VC node with unicast IPV6 IP address. 
 * Steps:
 * 1. Launch HPSUM.
 ...
 * Variables to update: remoteHostIpv6u_vc1, remoteHostUserName1u_vc1,remoteHostPassword1u_vc1, remoteHostIpv6u_oa1(use the OA which is associated with VC).
 */



public class ipv6_unicast_vc_deploy extends TestSuiteBase {
	...
	@Test
	public void test_ipv6_unicast_vc_deploy() {
		...
		try {
			...
			String remoteHostIp_vc1 			= CONFIG.getProperty("remoteHostIpv6u_vc1");
			String remoteHostUserName1_vc1 	= CONFIG.getProperty("remoteHostUserName1u_vc1");
			String remoteHostPassword1_vc1 	= CONFIG.getProperty("remoteHostPassword1u_vc1");
