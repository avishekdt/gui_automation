 ...
 * Author: Praveen AC
 * Date: 05/16/2016
 * Test case Description: Check VC deployment using global IPV6 IP
 * Prerequisites: Configure localhost and VC node with global IPV6 IP address.
 * Steps:
 * 1. Launch HPSUM.
 ...
 * Variables to update: remoteHostIpv6g_vc1, remoteHostIpv6g_oa1(use the OA which is associated with VC).
 */



public class ipv6_global_vc_deploy extends TestSuiteBase {
	...
	public void test_ipv6_global_vc_deploy() {
		...
		try {
			...
			String remoteHostIp_vc1 			= CONFIG.getProperty("remoteHostIpv6g_vc1");
			...
			String remoteHostIp_oa1 		= CONFIG.getProperty("remoteHostIpv6g_oa1");
