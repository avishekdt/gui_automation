...
public class RemoteDeployToOa extends TestSuiteBase{
	...
	public void test_RemoteDeployToOA(String col1) {
		...
		try {
			...
			// Setup::
			// Find out if it is Win-OA or Lin-OA deployment.
			...
			printLogs("Remote host IP: " + remoteHostIp_oa);
			printLogs("Remote host Type: " + remoteHostType_oa);
			...
			// 5. Deploy Node.
			if(!Nodes.deployNode(remoteHostIp_oa, remoteHostType_oa)) {
				throw new TestException("Test Failed");
			}
